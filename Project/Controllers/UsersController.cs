    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var user = await _context.Users
                .FirstOrDefaultAsync(m => m.UserdId == id);
            if (user == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("UserdId,Fullname,Password,Email")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserdId,Fullname,Password,Email")] User user)
        {
            if (id != user.UserdId)
            {
                return NotFound();
